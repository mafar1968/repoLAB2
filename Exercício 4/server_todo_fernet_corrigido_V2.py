...
try:
    with open('todo_list.fernet', 'r') as file:
        ...
        for line in file:
            ...
            # Criar o item e configurar o status de completo
            item = TodoItem(title, description)
            item.completed = completed.lower() == "true"  # Converte para booleano
            todo_list.items.append(item)  # Adiciona o item à lista
